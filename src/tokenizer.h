...
#define KEYWROD_DATATYPE_INT "INT"
#define KEYWROD_DATATYPE_TEXT "TEXT"

#define ALL_KEYWORDS_LIST {KEYWORD_CREATE, KEYWORD_TABLE, KEYWORD_INSERT, KEYWORD_INTO, KEYWORD_VALUES, KEYWORD_SELECT, KEYWORD_WHERE, KEYWORD_DELETE, KEYWORD_FROM, KEYWORD_DROP, KEYWROD_DATATYPE_TEXT, KEYWROD_DATATYPE_INT}
